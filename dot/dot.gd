...
func highlight_dot():
	...
	highlight_tween.tween_property(dot_sprite_2d, "modulate", highlight_color, 0.125)
	highlight_tween.parallel().tween_property(dot_sprite_2d, "scale", Vector2.ONE, 0.125)
...
func dehighlight_dot():
	...
	dehighlight_tween.tween_property(dot_sprite_2d, "modulate", normal_color, 0.1)
	dehighlight_tween.parallel().tween_property(dot_sprite_2d, "scale", Vector2.ZERO, 0.1)
